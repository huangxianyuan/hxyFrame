	...
	<form class="form-horizontal  bv-form" id="articleForm">
			...
			<div class="form-group col-xs-12 ">
				...
				<div class="col-xs-9">
					<span class="col-xs-11 block input-icon input-icon-right">
						<input id="title" datatype="*1-512" nullmsg="文章标题不能为空!" name="title" type="text" class="form-control" value="${article.title}"/>
					</span>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="form-group col-xs-12 ">
				...
				<div class="col-xs-9">
					<span class="col-xs-11 block input-icon input-icon-right">
						<input id="author" datatype="*1-64" nullmsg="作者不能为空!" name="author" type="text" class="form-control" value="${article.author}"/>
					</span>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="form-group col-xs-12 ">
				...
				<div class="col-xs-9">
					<span class="col-xs-11 block input-icon input-icon-right">
						<div class="col-xs-9">
							<%--<input  datatype="*1-512" nullmsg="封面不能为空!" id="img" name="img" type="text" value="${article.img}"/>--%>
							<img src="${article.img}" style="width: 215px" id="img" name="img"/>
						</div>
						<div class="col-xs-9">
